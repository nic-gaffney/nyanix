...
mkdir -p $HOME/.local/opt/cross64
mkdir -p $HOME/.local/src
export PREFIX="$HOME/.local/opt/cross64"
...
mkdir build-binutils-2.45
cd build-binutils-2.45
...
export PATH="$HOME/.local/opt/cross64/bin:$PATH"
